...
### 方式三：Windows 桌面端（推荐普通用户）

前往 [Releases](https://github.com/97Gz/StockNova/releases) 下载 `StockNova-v0.1.0-win64.zip`，解压后双击 `StockNova.exe` 即可运行（绿色版，含系统托盘）。
